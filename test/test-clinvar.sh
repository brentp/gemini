...
####################################################################
echo "    clinvar.t01...\c"
echo "chrom	end	in_omim	clinvar_sig	clinvar_disease_name	clinvar_dbsource	clinvar_dbsource_id	clinvar_origin	clinvar_dsdb	clinvar_dsdbid	clinvar_disease_acc	clinvar_in_locus_spec_db	clinvar_on_diag_assay	clinvar_causal_allele
chr1	985955	1	pathogenic	Myasthenic_syndrome,_congenital,_with_pre-_and_postsynaptic_defects	OMIM_Allelic_Variant	103320.0001	germline	MedGen:OMIM:Orphanet	CN186031:615120:ORPHA590	RCV000019902.27	1	0	C
...
gemini query -q "select chrom, end, in_omim,
                        ...
                        clinvar_causal_allele from variants" \
						--header test.clinvar.db > obs
check obs exp
#rm obs exp
